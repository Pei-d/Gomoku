...
QT_MOC_LITERAL(1, 8, 11), // "chessDroped"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 1), // "x"
QT_MOC_LITERAL(4, 23, 1), // "y"
QT_MOC_LITERAL(5, 25, 13) // "boardGameOver"

    },
    "mainwin\0chessDroped\0\0x\0y\0boardGameOver"
};
...
void mainwin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->chessDroped((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->boardGameOver(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (mainwin::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainwin::chessDroped)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (mainwin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainwin::boardGameOver)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void mainwin::chessDroped(int _t1, int _t2)
{
